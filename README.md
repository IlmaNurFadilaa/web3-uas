...
Aplikasi ini adalah platform donasi berbasis Web3 sederhana. Pengguna dapat menghubungkan dompet digital (MetaMask), memilih kampanye donasi, dan mengirimkan donasi menggunakan Ethereum (ETH) di jaringan Sepolia Testnet.

Aplikasi ini juga mencatat riwayat transaksi yang berhasil ke dalam sistem backend sederhana.
